    ...
    <section id="work" className="px-5 py-24 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-end">
          <SectionHeader align="left" eyebrow="Featured Projects" title="Apps and websites with a point of view" text="The work spans consumer apps, accountability systems, business operations, premium websites, and launch funnels." />
          <Reveal delay={0.08}>
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2">
          {projects.map((project, index) => (
            <Reveal key={project.name} delay={index * 0.06}>
              <article className="group relative min-h-72 overflow-hidden rounded-lg border border-white/10 bg-white/[0.035] p-6 transition duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/[0.06]">
                ...
                <p className="mt-8 max-w-xl leading-8 text-neutral-400">{project.text}</p>
